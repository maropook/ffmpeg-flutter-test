// 9/20
// カメラ機能のみで，動画を録画し，その動画と字幕ファイルを合成する．
...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  void onStopButtonPressed() {
    stopVideoRecording().then((file) {
      ...
      if (file != null) {
        ...
        //     "-y -i ${"/Users/hasegawaitsuki/ghq/github.com/maropook/ffmpeg_flutter_test/assets/a.mp4"} -vf scale=1920:1080,pad=1920:1080:0:0:black -c:v mpeg4 ${"/Users/hasegawaitsuki/ghq/github.com/maropook/ffmpeg_flutter_test/assets/camera.mp4"} ";
        // // どのvideoと合成するか．
  ...
  Future<String> returnVideoPath() async {
    if (videoFile == null) {
      return '/Users/hasegawaitsuki/ghq/github.com/maropook/ffmpeg_flutter_test/assets/video.mp4';
    }
